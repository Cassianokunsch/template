<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JanEnviarAtividade.aspx.cs" Inherits="UISUBALUNO_JanEnviarAtividade" %>
                        ...
                        <form role="form">
							<div class="form-group">
                                ...
                                <select class="form-control" name="atividade">
									<option value="3"selected>Ensino</option>
									<option value="4">Pesquisa</option>
									<option value="6">Extensão</option>
									<option value="5">Representação Estudantil</option>
								</select>
                            </div>
                            <div class="form-group">
                                <label>Atividade</label>
								<select class="form-control" name="categoria">
									<option value="2">Participação em projeto de pesquisa como bolsista ou voluntário semestre 10</option>
									<option value="3">Publicação de artigo completo em anais de simpósios ou encontros publicação 3</option>
								</select>
                            </div>
							...
							<div class="form-group">
								...
								<input name="creditos" class="form-control">
                            </div>
							...
							<div class="form-group">
							<button runat="server" type="button" onserverclick=enviaAtv class="btn btn-primary">Enviar atividade</button>
							</div>
						</form>
					</div>
				</div>
